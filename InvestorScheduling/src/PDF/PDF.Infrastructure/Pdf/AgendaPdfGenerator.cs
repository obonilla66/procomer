    ...
    private void ComposeContent(IContainer container, AgendaPdfData agenda)
    {
        container.PaddingTop(15).Column(column =>
        {
            ...
            column.Item().Table(table =>
            {
				...
				table.Header(header =>
				{
					header.Cell().Element(c => c.Background(Colors.Blue.Darken3).Padding(5).Text("Inicio").FontColor(Colors.White).Bold().FontSize(8));
					header.Cell().Element(c => c.Background(Colors.Blue.Darken3).Padding(5).Text("Fin").FontColor(Colors.White).Bold().FontSize(8));
					header.Cell().Element(c => c.Background(Colors.Blue.Darken3).Padding(5).Text("Participante").FontColor(Colors.White).Bold().FontSize(8));
					header.Cell().Element(c => c.Background(Colors.Blue.Darken3).Padding(5).Text("Cargo").FontColor(Colors.White).Bold().FontSize(8));
					header.Cell().Element(c => c.Background(Colors.Blue.Darken3).Padding(5).Text("Oficina").FontColor(Colors.White).Bold().FontSize(8));
					header.Cell().Element(c => c.Background(Colors.Blue.Darken3).Padding(5).Text("Dirección").FontColor(Colors.White).Bold().FontSize(8));
					header.Cell().Element(c => c.Background(Colors.Blue.Darken3).Padding(5).Text("Idioma").FontColor(Colors.White).Bold().FontSize(8));
				});
